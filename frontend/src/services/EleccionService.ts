...
export class EleccionService {
  static obtenerElecciones(): Promise<Array<Eleccion>> {
    return new Promise<Array<Eleccion>>((resolve, reject) => {
      apiClient
        ...
        .catch((error) => {
          console.error("Error in obtenerElecciones:", error);
          reject(
  ...
  crearEleccion(eleccion: Eleccion): Promise<Eleccion> {
    ...
    getMesasByEleccionYRecinto(eleccionId: number, recintoId: number): Promise<Array<Mesa>> {
    ...
    crearYDistribuir(eleccionId: number, recintos: Array<{ recinto: number; mesas: number }>, votantes: number[]): Promise<Mesa[]> {
        return new Promise<Mesa[]>((resolve, reject) => {
            ...
            apiClient
                ...
                .catch((error) => {
                    ...
                    reject(new Error("Error al crear y distribuir mesas: " + error.message));
                });
        });
    }
